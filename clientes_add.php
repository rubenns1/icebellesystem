...
<body>
  ...
  //session_start();
  //include_once("./check.php");
  $getNome = $_POST["CLIENTE"];
  $getWhatsApp = $_POST["WHATSAPP"];
  $getUnidade = $_POST["UNIDADE"];
  ...
  $queryMySQL = "INSERT INTO CLIENTES(NOME, ID_EMPRESA, DATA_CADASTRO, WHATSAPP) VALUES('{$getNome}', (SELECT ID FROM EMPRESAS WHERE NOME = '{$getUnidade}'), NOW(), '$getWhatsApp')";
  try {
    $runQuery = mysqli_query($mysqliStart, $queryMySQL);
    echo
    "
        <div class='alert alert-success' role='alert' style='text-align:center;'>
        <span style='font-weight:bold;'><i class='bi bi-info-circle'></i>&nbsp;{$getNome}</span> Cadastrado com sucesso, <a href='./clientes.php' class='link'>voltar</a>.
        </div>
        ";
    ...
    "
        ...
        <span style='font-weight:bold;'><i class='bi bi-exclamation-circle'></i>&nbsp;Fatal Error Exception</span></br>{$exception}</br><a href='./clientes.php' class='link'>Voltar</a>
        </div>
        ";
  }
  ?>
