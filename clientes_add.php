...
<body>
  ...
  $objCliente->setNome($_POST["CLIENTE"]);
  $objCliente->setContato($_POST["WHATSAPP"]);
  $objCliente->setEmpresa($_POST["UNIDADE"]);
  ...
  try {
    $executeQuery = mysqli_query($objDatabase->InicioDatabase(), $objDatabase->InserirCliente($objCliente->getNome(), $objCliente->getEmpresa(), $objCliente->getContato()));
    echo
    "
        <div class='alert alert-success' role='alert' style='text-align:center;'>
        <span style='font-weight:bold;'><i class='bi bi-info-circle'></i>&nbsp;{$objCliente->getNome()}</span> Cadastrado com sucesso, <a href='./clientes.php' class='link'>voltar</a>.
        </div>
        ";
