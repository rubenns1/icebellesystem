...
<body>
    ...
    <div class="container">
        <div class="box">
            ...
            <form action="./clientes_add.php" method="POST">
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input class="form-control" type="text" name="CLIENTE" placeholder="Fulano Silva" required>
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input class="form-control" type="text" name="WHATSAPP" placeholder="5511912345678">
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select class="custom-select" id="inputGroupSelect01" name="UNIDADE" required>
                            <?php
                            ...
                            $selectEmpresas = "SELECT * FROM EMPRESAS ORDER BY NOME";
                            $executeSelect = mysqli_query($mysqliStart, $selectEmpresas);

                            while ($loadingData = mysqli_fetch_assoc($executeSelect)) {
                                if ($loadingData["ID"] > 0) {
                            ?>
                                    <option value="<?php echo $loadingData["NOME"]; ?>"><?php echo $loadingData["NOME"]; ?></option><?php
                                                                                                                                        } else {
                                                                                                                                        }
                                                                                                                                    }
                                                                                                                                            ?>
                ...
                <button type="submit" class="btn btn-dark" id="finalizar-cadastro"><i class="bi bi-check">&nbsp;</i>Finalizar Cadastro</button>
            </form>
        </div>
        <!--Fim formulário-->
    </div>
