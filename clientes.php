        ...
        <div class="box">
            ...
            <form action="./clientes_add.php" method="POST">
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <label class="input-group-text"><i class="bi bi-building text-primary"></i></label>
                        </div>
                        <select class="custom-select" id="inputGroupSelect01" name="UNIDADE" required>
                            ...
                            $selectEmpresas = "SELECT ID, NOME FROM EMPRESAS ORDER BY NOME";
                            $executeSelect = mysqli_query($mysqliStart, $selectEmpresas);

                            while ($loadingData = mysqli_fetch_assoc($executeSelect)) {
                                if ($loadingData["ID"] > 0) {
                            ?>
                                    <option value="<?php echo $loadingData["NOME"]; ?>"><?php echo $loadingData["NOME"]; ?></option>
                            <?php
                                }
                            }
                            ?>
