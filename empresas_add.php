...
<body>
  ...
  $insertPost = "INSERT INTO EMPRESAS(NOME, DATA_CADASTRO) VALUES('{$getUnidade}', NOW())";

  try {
    mysqli_query($mysqliStart, $insertPost);
    echo
    "
        <div class='alert alert-success' role='alert' style='text-align:center;'>
        <i class='bi bi-info-circle'></i>&nbsp;Empresa <span style='font-weight:bold;'>{$getUnidade}</span> cadastrada com sucesso, <a href='./empresas.php' class='link'>voltar</a>.
        </div>
        ";
    ...
    "
        ...
        <span style='font-weight:bold;'><i class='bi bi-exclamation-circle'></i>&nbsp;Fatal Error Exception</span></br>{$exception}</br><a href='./empresas.php' class='link'>Voltar</a>
        </div>
        ";
    mysqli_close($mysqliStart);
  }
