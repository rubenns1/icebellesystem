...
<body>
  ...
  $objEmpresa->setNome($_POST["UNIDADE"]);

  try {
    mysqli_query($objDatabase->InicioDatabase(), $objDatabase->InserirEmpresa($objEmpresa->getNome()));
    echo
    "
        <div class='alert alert-success' role='alert' style='text-align:center;'>
        <i class='bi bi-info-circle'></i>&nbsp;Empresa <span style='font-weight:bold;'>{$objEmpresa->getNome()}</span> cadastrada com sucesso, <a href='./empresas.php' class='link'>voltar</a>.
        </div>
        ";
